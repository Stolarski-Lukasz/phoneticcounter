...
def count_consonants_a(request):
    ...
    measurement = Measurements(search_type = 'consonants_a', text_sample = user_text[:100], text_length = len(some_list), result = consonant_count_a)
    measurement.save()
...
def count_consonants_b(request):
    ...
    measurement = Measurements(search_type = 'consonants_b', text_sample = user_text[:100], text_length = len(some_list), result = consonant_count_b)
    measurement.save()
    return JsonResponse(data)
...
def count_vowels_a(request):
    ...
    measurement = Measurements(search_type = 'vowels_a', text_sample = user_text[:100], text_length = len(some_list), result = vowel_count_a)
    measurement.save()
    return JsonResponse(data)
...
def count_vowels_b(request):
    ...
    measurement = Measurements(search_type = 'vowels_b', text_sample = user_text[:100], text_length = len(some_list), result = vowel_count_b)
    measurement.save()
    return JsonResponse(data)
...
def count_phonemes_a(request):
    ...
    measurement = Measurements(search_type = 'phonemes_a', text_sample = user_text[:100], text_length = len(user_string_to_list(user_text)), result = phoneme_count_a)
    measurement.save()
    return JsonResponse(data)
...
def count_phonemes_b(request):
    ...
    measurement = Measurements(search_type = 'phonemes_b', text_sample = user_text[:100], text_length = len(user_string_to_list(user_text)), result = phoneme_count_b)
    measurement.save()
    return JsonResponse(data)
...
def count_syllables(request):
    ...
    measurement = Measurements(search_type = 'syllables', text_sample = user_text[:100], text_length = len(some_list), result = syllable_count)
    measurement.save()
    return JsonResponse(data)
